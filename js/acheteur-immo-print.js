    ...
    return cards.map(function (card, i) {
      ...
      qsa("[data-owner-field]", card).forEach(function (el) {
        ...
        var labels = {
          ...
          maritalDate: "Date mariage/PACS/divorce",
          maritalPlace: "Lieu mariage/PACS/divorce",
          marriageContract: "Contrat de mariage",
          notary: "Notaire rédacteur",
          addedBy: "Ajouté par",
          birthDate: "Date de naissance",
          birthPlace: "Lieu de naissance",
          nationality: "Nationalité",
          socialSecurity: "N° sécurité sociale",
          nationalId: "N° identité nationale",
