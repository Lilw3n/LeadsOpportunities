...
window.CrmImmoSchema = (function () {
  ...
  var UNIT_SECTIONS = [
    ...
    {
      id: "loyers",
      label: "Loyers & surfaces",
      hint: "HC/CC, charges, Carrez — agrégé dans les totaux composition.",
      fields: [
        { id: "occupation", label: "Occupation", type: "occupation", important: true },
        {
          id: "loyer_mode",
          label: "Loyer HC ou CC",
          type: "select",
          important: true,
          options: [
            { value: "HC", label: "Hors charges (HC)" },
            { value: "CC", label: "Charges comprises (CC)" },
          ],
        },
        { id: "loyer_hc", label: "Loyer HC", type: "number", unit: "€", important: true },
        { id: "loyer_cc", label: "Loyer CC", type: "number", unit: "€" },
        { id: "loyer_previsionnel", label: "Loyer prévisionnel", type: "number", unit: "€" },
        { id: "charges_locatives", label: "Charges locatives / mois", type: "number", unit: "€", important: true },
        {
          id: "charges_type",
          label: "Type de charges",
          type: "select",
          options: ["", "Provisions", "Forfait", "Réelles", "Incluses CC", "Autre"],
        },
        { id: "depot_garantie", label: "Dépôt de garantie", type: "number", unit: "€" },
        { id: "price", label: "Prix / valeur vénale", type: "number", unit: "€" },
        { id: "surface_carrez", label: "Surface loi Carrez", type: "number", unit: "m²", important: true },
        { id: "surface_non_carrez", label: "Surface hors Carrez", type: "number", unit: "m²" },
        { id: "surface_utile", label: "Surface utile", type: "number", unit: "m²" },
        { id: "surface_m2", label: "Surface annoncée", type: "number", unit: "m²" },
      ],
    },
    {
      id: "confort",
      label: "Chauffage & annexes",
      hint: "Cheminée, PAC, chaudière, mezzanine, balcon, véranda, plateau nu…",
      fields: [
        {
          id: "type_chauffage",
          ...
          type: "select",
          important: true,
          options: ["", "Individuel", "Collectif", "Mixte", "Aucun / à prévoir", "Autre"],
        },
        {
          id: "energie_chauffage",
          label: "Énergie",
          type: "select",
          options: ["", "Gaz", "Électricité", "Fioul", "Bois / granulés", "Pompe à chaleur", "Réseau urbain", "Autre"],
        },
        { id: "pompe_chaleur", label: "Pompe à chaleur", type: "checkbox" },
        {
          id: "chaudiere",
          label: "Chaudière",
          type: "select",
          options: ["", "Gaz", "Fioul", "Électrique", "Bois", "Absente", "Autre"],
        },
        { id: "cheminee", label: "Cheminée", type: "checkbox" },
        { id: "climatisation", label: "Climatisation", type: "checkbox" },
        { id: "mezzanine", label: "Mezzanine", type: "checkbox" },
        { id: "balcon", label: "Balcon", type: "checkbox" },
        { id: "terrasse", label: "Terrasse", type: "checkbox" },
        { id: "veranda", label: "Véranda", type: "checkbox" },
        { id: "plateau_nu", label: "Plateau nu", type: "checkbox" },
        { id: "cave", label: "Cave", type: "checkbox" },
        { id: "parking", label: "Parking / box", type: "checkbox" },
        { id: "digicode", label: "Digicode", type: "text", important: true },
        { id: "porte_numero", label: "N° de porte", type: "text", important: true },
        { id: "parking_numero", label: "N° parking / box", type: "text" },
        { id: "garage_numero", label: "N° garage", type: "text" },
        { id: "equipements_notes", label: "Notes équipements", type: "textarea" },
      ],
    },
    {
      id: "pieces",
      label: "Pièces",
      hint: "Liste libre + attributs (cheminée, balcon, plateau nu…) — totaux immeuble recalculés.",
      fields: [
    ...
    {
      id: "bail_unit",
      label: "Bail & locataire",
      hint: "Bail et fiche locataire du lot.",
      fields: [
        { id: "locataire_nom", label: "Locataire — nom", type: "text", important: true },
        { id: "locataire_prenom", label: "Locataire — prénom", type: "text" },
        { id: "locataire_tel", label: "Téléphone", type: "text" },
        { id: "locataire_email", label: "E-mail", type: "text" },
        { id: "locataire_employeur", label: "Employeur", type: "text" },
        { id: "locataire_revenus", label: "Revenus mensuels", type: "number", unit: "€" },
        { id: "garant_nom", label: "Garant / caution", type: "text" },
        {
          id: "type_bail",
          label: "Type de bail",
          type: "select",
    ...
    },
    {
      id: "investisseur",
      label: "Investisseur",
      hint: "Rendements, charges propriétaire, cash-flow.",
      fields: [
        { id: "rendement_brut", label: "Rendement brut", type: "number", unit: "%", important: true },
        { id: "rendement_net", label: "Rendement net", type: "number", unit: "%" },
        { id: "cashflow_mensuel", label: "Cash-flow mensuel", type: "number", unit: "€" },
        { id: "vacance_locative_jours", label: "Vacance locative", type: "number", unit: "j/an" },
        { id: "taxe_fonciere", label: "Taxe foncière / an", type: "number", unit: "€" },
        { id: "assurance_pno", label: "Assurance PNO / an", type: "number", unit: "€" },
        { id: "frais_gestion", label: "Frais de gestion / an", type: "number", unit: "€" },
        { id: "investor_notes", label: "Notes investisseur", type: "textarea" },
      ],
    },
    {
      id: "copro_syndic",
      label: "Syndic & copro",
      hint: "Syndic, travaux, procédures, parties communes.",
      fields: [
        { id: "syndic_nom", label: "Syndic", type: "text", important: true },
        { id: "syndic_contact", label: "Contact syndic", type: "text" },
        { id: "syndic_tel", label: "Tél. syndic", type: "text" },
        { id: "syndic_email", label: "E-mail syndic", type: "text" },
        { id: "nb_lots_copro", label: "Nb lots copro", type: "number" },
        { id: "charges_copro", label: "Charges copro / mois", type: "number", unit: "€" },
        { id: "fonds_travaux", label: "Fonds de travaux", type: "number", unit: "€" },
        { id: "travaux_copro", label: "Travaux réalisés / en cours", type: "textarea" },
        { id: "travaux_prevus", label: "Travaux prévus / AG", type: "textarea" },
        { id: "procedure_en_cours", label: "Procédure en cours", type: "checkbox", important: true },
        { id: "procedure_details", label: "Détail procédure", type: "textarea" },
      ],
    },
    {
      id: "proprietaire",
      label: "Propriétaire",
      hint: "Coordonnées, régime matrimonial, origine (donation, héritage…).",
      fields: [
        { id: "proprietaire_nom", label: "Nom", type: "text", important: true },
        { id: "proprietaire_prenom", label: "Prénom", type: "text" },
        { id: "proprietaire_tel", label: "Téléphone", type: "text" },
        { id: "proprietaire_email", label: "E-mail", type: "text" },
        {
        ...
        },
        {
          ...
          type: "select",
          important: true,
          options: ["", "Achat", "Donation", "Héritage / succession", "Licitation", "Apport en société", "Construction", "Autre"],
        },
        { id: "date_acquisition", label: "Date d'acquisition", type: "date" },
        { id: "prix_acquisition", label: "Prix d'acquisition", type: "number", unit: "€" },
        { id: "notaire_nom", label: "Notaire", type: "text" },
        { id: "proprietaire_notes", label: "Notes propriétaire", type: "textarea" },
      ],
    },
    {
      id: "medias",
