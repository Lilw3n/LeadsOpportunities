...
(function (global) {
  ...
  var SERVICES = {
    ...
    "vendeur-immo": {
      need: "vendeur-immo",
      label: "Parcours vendeur immobilier",
      category: "finance",
      vertical: "vendeur_immo",
      landing: "./landings/vendeur-immo.html",
    },
    patrimoine: {
      need: "patrimoine",
      label: "Patrimoine & prevoyance",
      category: "patrimoine",
      vertical: "patrimoine",
      landing: "./landings/patrimoine.html",
    },
    "banque-epargne": {
      need: "banque-epargne",
      ...
      landing: "./landings/banque-epargne.html",
    },
    ...
    habitation: {
      ...
      category: "habitat",
      vertical: "habitation",
      landing: "./landings/habitation-immo.html",
    },
    pno: {
      need: "pno",
      label: "PNO",
  ...
  var COMPLET_LANDINGS = {
    ...
    "vendeur-immo": "./landings/vendeur-immo.html",
    habitation: "./landings/habitation-immo.html",
    mrh: "./landings/habitation-immo.html",
    pno: "./landings/habitation-immo.html",
    patrimoine: "./landings/patrimoine.html",
    "banque-epargne": "./landings/banque-epargne.html",
    retraite: "./landings/patrimoine.html",
    "assurance-vie": "./landings/patrimoine.html",
  };
