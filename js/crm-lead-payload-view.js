...
(function (global) {
  var FIELD_LABELS = {
    ...
    searchKind: "Recherche immobilière",
    propertySought: "Type(s) de bien recherché(s)",
    sellerType: "Vendeur (pro ou particulier)",
    needsAdditionalImmoSupport: "Prestation complémentaire souhaitée",
    serviceSought: "Prestation(s) complémentaire(s)",
  ...
  var VALUE_LABELS = {
    ...
    bien: "Recherche d'un bien immobilier",
    service: "Prestation immobilière seule",
    les_deux: "Recherche d'un bien + prestation complémentaire",
    maison: "Maison",
