...
(function (global) {
  var FIELD_LABELS = {
    ...
    serviceSought: "Accompagnement en plus (syndic, gestion…)",
  ...
  var VALUE_LABELS = {
    ...
    bien: "Recherche de bien (accompagnement)",
    service: "Prestation hors recherche de bien",
    les_deux: "Recherche de bien + autre accompagnement",
    maison: "Maison",
    ...
    transaction: "Accompagnement transaction (ancien)",
