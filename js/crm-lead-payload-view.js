...
(function (global) {
  ...
  var VALUE_LABELS = {
    ...
    bail_commercial: "Bail commercial / ILC-ILAT",
    commercial: "Bail commercial et fiscalité",
    locationCommercialIndex: "Indexation loyer commercial",
    locationTvaCas: "Situation TVA",
    teom: "TEOM (ordures ménagères)",
    cfe: "CFE",
    meuble: "Location meublée et exonérations",
    locationFurnished: "Meublé / nu",
    locationMeubleRegime: "Régime meublé / exonération",
    lmnp_micro: "LMNP micro-BIC",
    lmnp_reel: "LMNP réel",
    chambre_habitant: "Chambre chez l’habitant",
    conges: "Congés locataire / bailleur / commercial",
    conge_commercial: "Congé / bail commercial",
    locationCongeAuteur: "Congé donné par",
    locationCongeEcheance: "Échéance / date d’effet du congé",
