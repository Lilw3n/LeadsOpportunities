...
(function () {
  ...
  function collectFormPartial(form) {
    ...
    ["buyerNeeds", "propertySought", "serviceSought", "ownerRole[]", "ownerFirstName[]", "ownerLastName[]", "ownerPhone[]", "ownerEmail[]", "ownerAddress[]", "ownerPostal[]", "ownerCity[]", "roomLevel[]", "roomName[]", "roomSurface[]", "roomDimensions[]", "roomFlooring[]", "roomExposure[]", "sellEquip[]", "sellCommit[]", "sellFurniture[]", "sellDoc[]", "coproWorkNature[]", "coproWorkStatus[]", "coproWorkAmount[]", "coproWorkDate[]", "coproWorkShare[]", "coproWorkNote[]"].forEach(function (key) {
