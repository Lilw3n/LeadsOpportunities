...
(function (root) {
  var LABELS = {
    ...
    sellListingTitle: "Titre de l'annonce",
    ...
    sellAvailability: "Disponibilité",
    sellAvailabilityStart: "Début de disponibilité",
    sellDpeDate: "Date de réalisation du DPE",
    sellDpeRefSurface: "Surface de référence DPE (m²)",
    sellDpe: "DPE (lettre)",
    sellDpeKwh: "DPE (kWh/m²/an)",
    sellGes: "GES (lettre)",
    sellGesKg: "GES (kg CO₂/m²/an)",
    sellDpeExempt: "Non soumis au DPE",
    sellEnergyCostAnnual: "Dépenses annuelles d'énergie (€)",
    sellTaxeFonciere: "Taxe foncière (€/an)",
  ...
  var VALUE_LABELS = {
    ...
    bon: "bon",
    excellent: "excellent",
    a_renover_entierement: "à rénover entièrement",
    a_renover: "à rénover",
    ...
    immediate: "immédiate",
    a_l_acte: "à l'acte",
    deux_mois_apres_acte: "deux mois après l'acte",
    apres_travaux: "après travaux",
    date_a_convenir: "date à convenir",
    fin_de_location: "fin de location",
    a_l_achevement: "à l'achèvement",
    viager_libre: "viager libre",
    viager_occupe: "viager occupé",
    libre: "Libre",
    occupe: "Occupé",
