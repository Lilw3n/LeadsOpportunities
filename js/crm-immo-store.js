  ...
  function seedDemoIfEmpty() {
    ...
    var props = [
      ...
      },
      {
        ...
        price_fai: 420000,
        price_net: 400000,
        price_listing: 445000,
        has_garage: true,
        has_garden: true,
        has_terrace: true,
        dpe: "D",
        description:
          "Maison familiale de 1978 sur terrain d’environ 650 m². Séjour lumineux, cuisine indépendante, 4 chambres, garage et terrasse.",
        details: {
          localisation: {
          ...
          finances: { prix_fai: 420000, prix_net: 400000, prix_annonce: 445000, honoraires: 20000 },
          surfaces: { surface_habitable: 120, surface_terrain: 650, nb_pieces: 5, nb_chambres: 4 },
          commentaires: { points_forts: "Jardin, garage, proximité tram" },
          exterieur: { jardin: "yes", terrasse: "yes", garage: "yes" },
        },
      },
      {
        id: uid("prop"),
        ref: "4200",
        title: "Maison chalet — Varangéville",
        property_type: "maison",
        transaction: "vente",
        status: "prospection",
        listing_source: "leboncoin",
        ...
        postal_code: "54110",
        department: "54",
        address: "95 Rue Georges Toussaint",
        surface_m2: 200,
        rooms: 8,
        bedrooms: 5,
        price_fai: 270000,
        price_net: 255000,
        price_listing: 290000,
        honoraires: 15000,
        has_garage: true,
        has_garden: true,
        has_terrace: true,
        dpe: "E",
        description:
          "Maison type chalet (1975) sur terrain ~1000 m². Arbres fruitiers, terrasse bois ~80 m², pompe à chaleur + insert, appoint fioul, grand garage. Pige Directannonces — ne pas contacter le vendeur sans accord.",
        details: {
          localisation: {
            adresse: "95 Rue Georges Toussaint",
            code_postal: "54110",
            ville: "Varangéville",
            departement: "54",
          },
          finances: { prix_fai: 270000, prix_net: 255000, prix_annonce: 290000, honoraires: 15000 },
          surfaces: { surface_habitable: 200, surface_terrain: 1000, nb_pieces: 8, nb_chambres: 5 },
          commentaires: {
            points_forts: "Terrain, terrasse, garage, chauffage récent",
            observations_generales: "Annonce parue au prix de 290 000 € — mandat cible 270 000 € FAI.",
            url_origine_pige: "https://www.leboncoin.fr/",
          },
          exterieur: { jardin: "yes", terrasse: "yes", garage: "yes" },
          diagnostics: { conso_energie_primaire: "E" },
        },
      },
      {
        id: uid("prop"),
    ...
    db.parties = [
      ...
      },
      {
        ...
        role: "agence",
        name: "Laforêt Dombasle-sur-Meurthe",
        phone: "03 83 29 97 10",
        email: "dombasle-centre@laforet.com",
        address: "40 Rue Gabriel Péri — 54110 Dombasle-sur-Meurthe",
        company: "Interlocuteur : BUCHET Wendy",
      },
      {
        id: uid("party"),
        property_id: props[2].id,
        role: "vendeur",
        name: "Propriétaire (pige)",
        phone: "",
        email: "",
      },
    ];
    db.documents = [
      ...
      },
      {
        id: uid("idoc"),
        property_id: props[2].id,
        doc_type: "annonce_publique",
        title: "Fiche commerciale publique",
        status: "draft",
        visibility: "public",
        data: {},
        notes: "Document public de démonstration",
      },
    ];
    return saveLocal(db);
  }
