  ...
  GROUPS: [
    ...
    },
    {
      ...
      items: [
        ...
        { type: "link", href: "./crm-budget-proprietaire.html", label: "Budget propriétaire", icon: "immo", badge: "nouveau", highlight: true, desc: "Prêt + taxe foncière + énergies + travaux × salaire / apport / patrimoine", keywords: "budget proprietaire projection taxe fonciere charges electricite gaz eau travaux apport patrimoine reste a vivre" },
