  ...
  GROUPS: [
    ...
    },
    {
      ...
      items: [
        ...
        { type: "link", href: "./crm-assurance-immo.html", label: "Assurance immo", icon: "insurance", badge: "ADE", highlight: true, desc: "Emprunteur ADE, habitation MRH — switcher avec Prêts", keywords: "assurance emprunteur ade mrh habitation immo" },
