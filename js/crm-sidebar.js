...
window.CrmSidebar = {
  ...
  FAVORITES: [
    ...
    { href: "./crm-blog-stats.html", label: "Stats blog", icon: "stats" },
  ...
  GROUPS: [
    ...
    },
    {
      ...
      items: [
        ...
        { type: "link", href: "./crm-blog-stats.html", label: "Stats blog & forum", icon: "stats", badge: "vues·CTA", desc: "Articles : vues, clics CTA, leads first-party" },
    ...
    },
    {
      ...
      items: [
        ...
        { type: "link", href: "./crm-relations.html", label: "Relations & parrainage", icon: "contacts", desc: "Famille, SCI, héritiers, apporteurs", keywords: "parrainage apporteur famille conjoint sci heritier indivision" },
        { type: "link", href: "./crm-contact-modules.html", label: "Modules contact", icon: "tools" },
        { type: "link", href: "./crm-interlocutors.html", label: "Interlocuteurs", icon: "contacts", highlight: true, desc: "Fiches perso / pro / biens depuis le formulaire" },
    ...
    },
    {
      ...
      items: [
        ...
        { type: "link", href: "./crm-immo-utilisateurs.html", label: "Utilisateurs marché", icon: "users", badge: "admin", highlight: true, desc: "Contacter tous les acheteurs/vendeurs du marché (e-mail groupé super-admin)", keywords: "utilisateurs marche contact bulk email vendeur acheteur" },
        ...
        { type: "link", href: "./crm-agency-fees.html", label: "Barèmes / Financement", icon: "immo", desc: "Taux libre concurrents + barèmes + charges URSSAF/IR", keywords: "immo laforet honoraires commission bareme pret rachat financement acheteur urssaf taux libre concurrent vendeur" },
    ...
    },
    {
      ...
      items: [
        ...
        { type: "link", href: "./crm-partner-sites.html", label: "Sites partenaires", icon: "partner", highlight: true, desc: "Aperçus par catégorie + photo override" },
