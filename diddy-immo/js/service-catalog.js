...
(function (global) {
  ...
  function getService(need) {
    ...
    var ALIASES = {
      ...
      "location-gestion": "location",
      "gestion-locative": "location",
      "gestion_locative": "location",
      irl: "location",
      "revision-loyer": "location",
      revision_loyer: "location",
      colocation: "location",
      coloc: "location",
      travaux: "location",
      droits: "location",
      ...
      conges: "location",
      conge: "location",
      "conge-locataire": "location",
      "conge-bailleur": "location",
      "conge-commercial": "location",
      commercial: "location",
      "bail-commercial": "location",
      meuble: "location",
      lmnp: "location",
      exoneration: "location",
      fiscalite: "location",
      tva: "location",
      taxes: "location",
      cfe: "location",
  ...
  var RAPIDE_LANDINGS = {
    ...
    "location-gestion": "./landings/location.html?role=gestion",
    irl: "./landings/location.html?role=gestion&sujet=irl",
    "revision-loyer": "./landings/location.html?role=gestion&sujet=irl",
    colocation: "./landings/location.html?role=gestion&sujet=coloc",
    coloc: "./landings/location.html?role=gestion&sujet=coloc",
    ...
    conges: "./landings/location.html?role=gestion&sujet=conges",
    "conge-locataire": "./landings/location.html?role=locataire&sujet=conge-locataire",
    "conge-bailleur": "./landings/location.html?role=bailleur&sujet=conge-bailleur",
    "conge-commercial": "./landings/location.html?role=gestion&sujet=conge-commercial",
    commercial: "./landings/location.html?role=gestion&sujet=commercial",
    "bail-commercial": "./landings/location.html?role=gestion&sujet=commercial",
    meuble: "./landings/location.html?role=gestion&sujet=meuble",
    lmnp: "./landings/location.html?role=gestion&sujet=lmnp",
    exoneration: "./landings/location.html?role=gestion&sujet=exoneration",
    fiscalite: "./landings/location.html?role=gestion&sujet=fiscalite",
    tva: "./landings/location.html?role=gestion&sujet=tva",
    taxes: "./landings/location.html?role=gestion&sujet=taxes",
    cfe: "./landings/location.html?role=gestion&sujet=cfe",
    teom: "./landings/location.html?role=gestion&sujet=teom",
