...
(function () {
  ...
  function buildShell() {
    ...
    var PAGE_META = {
      ...
      "crm-subscription-plans.html": { subtitle: "Grille d’abonnements publique · Stripe Checkout adaptable" },
      ...
      "crm-immo-tour-requests.html": { subtitle: "Valider ou décliner les demandes de visite virtuelle — aucun code automatique" },
      ...
      "crm-todoist.html": { subtitle: "Tâches Todoist — leads, événements agenda, aujourd’hui et en retard" },
      ...
      "crm-event-create.html": { subtitle: "Créer un RDV (Estimation, Visite…) sync Google Agenda + Todoist" },
      ...
      "crm-event-create.html": { subtitle: "Planifier un appel, RDV ou tâche (Google + Todoist)" },
