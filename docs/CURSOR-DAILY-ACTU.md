...
| `5` | Ajoute Google News et Bing si des candidats qualifies existent |

Exemple **5×/jour** : 5 automations à `count=1` (rotation auto) **ou** 1–2 runs/jour à `count=3`/`count=5`.
