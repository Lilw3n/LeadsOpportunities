...
2. npm run blog:actu:auto -- --count=1
   (ou --count=3 pour varier plusieurs plateformes en une fois)
...
| `3` | 3 sources differentes si le vivier contient assez de candidats |

Exemple **5×/jour** : 5 automations à `count=1` (rotation auto) **ou** 1–2 runs/jour à `count=3`.
