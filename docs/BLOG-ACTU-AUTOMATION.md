...
| **Edge / MSN** | Bing News : France, page d'accueil, actu, économie, assurance, mutuelle, immobilier, santé, sinistres |
| **Firefox** | France Info (titres/santé/éco), France 24, Mediapart, RFI, BFMTV, Europe 1, HuffPost, Courrier international + Pocket |
| **Google News** | Une France + rubriques France/économie/santé + 20+ requêtes assurance + **Coupe du monde 2026** |
...
| **Edge** (MSN actu) | Bing News RSS publics (MSN HTML n'est pas scrapé) |
| **Firefox** (France Info, 20 Minutes) | RSS Franceinfo + 20 Minutes |
| **Google News** | RSS Google News France + rubriques + recherches métiers assurance |
| **Bing** | RSS Bing News FR par requêtes généralistes et assurance |
