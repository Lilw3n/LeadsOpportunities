...
| `/crm-immo-property.html?id=` | **Fiche intelligente** : sections conditionnelles + composition unités + pièces + **vendeurs/acquéreurs illimités** |
...
- **Parties** : `crm_immo_parties` — N vendeurs / héritiers / acquéreurs par bien (`share_pct` optionnel pour l’indivision)
