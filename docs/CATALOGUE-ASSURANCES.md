...
**Actu automatique (Cafeyn, Edge, Firefox, Google News, Bing, Yahoo via RSS publics)** : voir `docs/BLOG-ACTU-AUTOMATION.md` — `npm run blog:actu:fetch`, boîte `blog/actu-inbox.html`, automation Cursor.
