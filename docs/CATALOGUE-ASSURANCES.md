...
**Actu automatique (Cafeyn, Edge, Firefox, Google, Bing, Yahoo, RSS)** : voir `docs/BLOG-ACTU-AUTOMATION.md` — `npm run blog:actu:fetch`, boîte `blog/actu-inbox.html`, automation Cursor.
