...
- **Facturation électronique (01/09/2026)** : `/crm-e-invoicing.html` · mix Tiime+CRM (`config/e-invoicing-stack.json`) · `docs/FACTURATION-ELECTRONIQUE.md` · `npm run verify:e-invoicing`
