/**
 * Actu — Extended Look GTA 6 sur Netflix → immobilier / crédit / habitation (FR).
 */
var LANDING_IMMO =
  "../landings/acheteur-immo.html?utm_source=blog&utm_medium=article&utm_campaign=gta6_netflix_immo";
var LANDING_CREDIT =
  "../landings/credit-immo.html?utm_source=blog&utm_medium=article&utm_campaign=gta6_netflix_immo";
var LANDING_HAB =
  "../landings/devis.html?need=habitation&utm_source=blog&utm_medium=article&utm_campaign=gta6_netflix_immo";
var CTA = { href: LANDING_CREDIT, label: "Étude prêt immobilier" };

module.exports = [
  {
    file: "gta-6-netflix-extended-look-immobilier-france-2026.html",
    section: "actu",
    ...
    blocks: [
      {
        ...
        text:
          ...
          LANDING_CREDIT +
          "\"><strong>Simuler mon prêt</strong></a> · <a href=\"" +
          LANDING_IMMO +
          "\">projet achat / vente</a>.",
      },
      { type: "bridge" },
      ...
      { type: "h2", text: "2. Vice City fantasy vs immobilier réel en France" },
      {
        ...
        text:
          ...
          LANDING_CREDIT +
          "\">Étude capacité d’emprunt</a> · <a href=\"./passoire-energetique-dpe-g-vendre-2026.html\">DPE G et vente</a>.",
      },
      {
        type: "ul",
        items: [
      ...
      },
      {
        type: "p",
        text:
          "Courtier ORIAS : on relie <strong>crédit</strong>, <strong>emprunteur</strong> et <strong>habitation</strong> sans jugoter votre passion gaming. <a href=\"" +
          LANDING_CREDIT +
          "\"><strong>Étude prêt gratuite</strong></a> · <a href=\"" +
          LANDING_IMMO +
          "\">acheteur / vendeur</a> · <a href=\"" +
          LANDING_HAB +
    ...
    related: [
      ...
      { href: "../landings/acheteur-immo.html", label: "Parcours immobilier" },
    ],
    faq: [
      {
