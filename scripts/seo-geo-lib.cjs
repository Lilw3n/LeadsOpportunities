...
function collectSitemapUrls(cities, departments, regions, base) {
  ...
  const urls = [
    ...
    { loc: base + "/landings/vendeur-immo.html", priority: "0.9", changefreq: "weekly" },
    { loc: base + "/landings/acheteur-vendeur-immo.html", priority: "0.88", changefreq: "weekly" },
    { loc: base + "/immobilier/", priority: "0.95", changefreq: "weekly" },
    { loc: base + "/negociateur-immobilier/", priority: "0.86", changefreq: "weekly" },
