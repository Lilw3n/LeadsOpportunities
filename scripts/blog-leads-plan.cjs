#!/usr/bin/env node
/**
 * Affiche le plan éditorial evergreen leads (cadence + verticales).
 *
...
console.log(cadence.goal || "Générer des leads via articles evergreen.");
console.log("Cron recommandé:", cadence.recommendedCron || "n/a");
