...
const { sourceLabel, resolveSourceType } = require("./blog-actu-sources.cjs");
...
function buildPrompt(candidate) {
  ...
  var platform = sourceLabel(candidate.sourceType || resolveSourceType(candidate.source || candidate.feedName));
  var sportBlock = "";
  ...
  return (
    ...
    "\nPlateforme source: " +
    platform +
    " (Cafeyn, Edge/MSN, Firefox/Pocket, Google News, Bing News, Yahoo ou autre flux public)\nNeed questionnaire: " +
    need +
    sportBlock +
    "\n" +
