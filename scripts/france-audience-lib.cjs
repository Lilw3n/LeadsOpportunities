...
var LEAD_INTENT_RE =
  /mutuelle|assurance|emprunteur|sinistre|habitation|inondation|canicule|orages?|alerte orange|s[eé]cheresse|cr[eé]dit|pr[eê]t immobil|rembours|ost[eé]opath|hospitalisation|vtc\b|animaux|v[eé]t[eé]rinair|catastrophe naturelle|loi lemoine|orias|franchise|pr[eé]voyance|piratage|cyberattaque|iban/i;
